...
class Node:
    ...
    The :code:`data` can either be a string or a tuple of nodes.
    The :code:`id` is initially None. When iterating through a tree with :code:`dfs`, the tree nodes get unique ids that can be used for local substitutions. As soon as a substitution has been performed, the ids are invalid.
    """
    __slots__ = 'id', 'data'
...
def dfs(exprs, max_depth = None):
    ...
    Updates exprs with fresh ids that can be used for subsequent substitutions.
    """
